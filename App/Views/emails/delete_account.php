...
<head>
    ...
    <!--<![endif]-->
	<title>Confirmez la suppression de votre compte</title>
	<!--[if gte mso 9]>
																...
																<th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																	<table width="100%" border="0" cellspacing="0" cellpadding="0">
																		...
																		<tr mc:hideable>
                                                                            ...
                                                                            La suppression du compte est irreversible, il sera impossible de le récupérer!
                                                                            Si vous souhaitez conserver votre compte, ne tenez pas compte de cet email et ne cliquez surtout pas sur le lien
																			</div></td>
																		...
																		<tr mc:hideable>
																			<td align="left">
																				<table border="0" cellspacing="0" cellpadding="0">
																					<tr>
																						<td class="text-button" style="color:#ffffff; background:#e41129; border-radius:5px; font-family:'Yantramanav', Arial, sans-serif; font-size:14px; line-height:18px; text-align:center; font-weight:500; padding:12px 25px;"><div mc:edit="text_8"><a href=<?=URL."confirm_delete_account/".$key_account ?> target="_blank" class="link-white" style="color:#ffffff; text-decoration:none;"><span class="link-white" style="color:#ffffff; text-decoration:none;">Supprimer mon compte</span></a></div></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr mc:hideable>
																		<td class="text-footer m-center" style="padding-bottom: 15px; color:#999999; font-family:Arial, sans-serif; font-size:14px; line-height:18px; text-align:left; min-width:auto !important;"><div mc:edit="text_18"> <a href="<?=URL?>">Cine-film</a></div></td>
																	</tr>
